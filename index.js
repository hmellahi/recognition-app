...
const greetings = ["Like you cares", "I am fine", "Go away son of bitch"];
const DarkMode  = "the theme has benn changed to the dark mode";
const LightMode  = "the theme has benn changed to the light mode";
...
function handleRequest(request)
{
  ...
  if(request.includes("what is your favorite team") || request.includes("is morocco your favorite team"))
      response = "diiiiiiiiiiiiidjskldsjiiiiiiiima raja";
